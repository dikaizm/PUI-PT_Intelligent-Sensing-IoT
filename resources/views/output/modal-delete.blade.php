...
<div class="modal fade" id="modalDelete{{ $detail->id }}" tabindex="-1"
    aria-labelledby="modalDeleteLabel{{ $detail->id }}" aria-hidden="true">
        ...
        <div class="modal-content card-style">
            ...
            <div class="modal-body px-0">
                <div class="content mb-30">
                    <p class="text-sm">
                        {{ __('Are you sure you want to delete ' . $detail->judul . '?') }}
                    </p>
                </div>
                <div class="action d-flex flex-wrap justify-content-end">
                    <form action=" {{ route('output-detail.destroy', ['id' => $detail->id]) }} " method="POST">
                        @method('DELETE')
                        @csrf
