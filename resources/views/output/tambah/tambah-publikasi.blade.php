<form action="{{ route('output-detail.store-publikasi') }}" method="POST">
  ...
  <div class="input-style-1">
    ...
    <input type="hidden" id="uuid" name="uuid" value="{{ isset($penelitian) ? $penelitian->uuid : '' }}">
  ...
  <div class="input-style-1">
    <label for="tautan">{{ __('Link Jurnal') }} <span style="color:gray;">{{ __('*Apabila sudah publish') }}</span>
    </label>
