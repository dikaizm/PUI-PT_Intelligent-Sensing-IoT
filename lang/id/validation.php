...
return [
    ...
    */
    ...
    'email' => 'Gunakan :attribute yang valid/aktif.',
    'ends_with' =>
    ...
    'max' => [
        'array' => ':attribute mohon tidak melebihi :max.',
        'file' => ':attribute tidak boleh lebih dari :max kilobytes (kb).',
    ...
    'min' => [
        'array' => 'Kolom :attribute harus memiliki setidaknya :min items.',
        'file' =>
            'Kolom :attribute harus memiliki setidaknya :min kilobytes (kb).',
        'numeric' => 'Kolom :attribute harus memiliki setidaknya :min.',
        'string' =>
            'Kolom :attribute harus memiliki setidaknya :min characters.',
    ],
    ...
    'regex' => ':attribute format penulisan tidak didukung.',
